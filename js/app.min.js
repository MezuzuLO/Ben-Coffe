...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/function.js */ \"./src/js/modules/function.js\");\n/* harmony import */ var _modules_burger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/burger.js */ \"./src/js/modules/burger.js\");\n/* harmony import */ var _modules_quality_coffe_buttonChanger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/quality-coffe-buttonChanger.js */ \"./src/js/modules/quality-coffe-buttonChanger.js\");\n/* harmony import */ var _modules_swiper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/swiper.js */ \"./src/js/modules/swiper.js\");\n/* harmony import */ var _modules_best_coffe_buttonChanger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/best-coffe-buttonChanger.js */ \"./src/js/modules/best-coffe-buttonChanger.js\");\n/* harmony import */ var _modules_our_dealer_buttonChanger_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/our-dealer-buttonChanger.js */ \"./src/js/modules/our-dealer-buttonChanger.js\");\n/* harmony import */ var _modules_coffe_members_buttonChanger_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/coffe-members-buttonChanger.js */ \"./src/js/modules/coffe-members-buttonChanger.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_function_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\nconsole.log('hello')\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");

/***/ }),

/***/ "./src/js/modules/best-coffe-buttonChanger.js":
/*!****************************************************!*\
  !*** ./src/js/modules/best-coffe-buttonChanger.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\nconst bestCoffeButton = document.querySelectorAll('.best-coffe-button')\r\nconst bestCoffeShop = document.querySelectorAll('.best-coffe-button__path')\r\n\r\nconst bestButtonHoverMedia = window.matchMedia('screen and (pointer: fine)')\r\n\r\nconst bestCoffeObject = {\r\n\t'0': [0, 1, 2],\r\n\t'1': [3, 4, 5],\r\n\t'2': [6, 7, 8],\r\n\t'3': [9, 10, 11],\r\n\t'4': [12, 13, 14],\r\n\t'5': [15, 16, 17],\r\n\t'6': [18, 19, 20],\r\n\t'7': [21, 22, 23],\r\n}\r\n\r\nif (bestButtonHoverMedia.matches) {\r\n\tbestCoffeButton.forEach((el, bestCoffeIndex) => {\r\n\t\tbestCoffeButton[bestCoffeIndex].addEventListener('mouseover', () => {\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.backgroundColor = '#ffffff'\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.color = '#222222'\r\n\t\t\tconsole.log(bestCoffeIndex)\r\n\t\t\tconsole.log(bestCoffeObject[`${bestCoffeIndex}`])\r\n\t\t\tlet bestCoffeShopArray = bestCoffeObject[`${bestCoffeIndex}`]\r\n\t\t\tbestCoffeShopArray.forEach((el, bestCoffeShopIndex) => {\r\n\t\t\t\tlet bestCoffeShopElement = el\r\n\t\t\t\tconsole.log(bestCoffeShopElement)\r\n\t\t\t\tbestCoffeShop[bestCoffeShopElement].style.transition = 'stroke 0.2s'\r\n\t\t\t\tbestCoffeShop[bestCoffeShopElement].style.stroke = '#222222'\r\n\t\t\t})\r\n\t\t})\r\n\t\tbestCoffeButton[bestCoffeIndex].addEventListener('mouseout', () => {\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.backgroundColor = '#222222'\r\n\t\t\tbestCoffeButton[bestCoffeIndex].style.color = '#ffffff'\r\n\t\t\tlet bestCoffeShopArray = bestCoffeObject[`${bestCoffeIndex}`]\r\n\t\t\tbestCoffeShopArray.forEach((el, bestCoffeShopIndex) => {\r\n\t\t\t\tlet bestCoffeShopElement = el\r\n\t\t\t\tconsole.log(bestCoffeShopElement)\r\n\t\t\t\tbestCoffeShop[bestCoffeShopElement].style.transition = 'stroke 0.2s'\r\n\t\t\t\tbestCoffeShop[bestCoffeShopElement].style.stroke = '#ffffff'\r\n\t\t\t})\r\n\t\t})\r\n\t})\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/best-coffe-buttonChanger.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n\r\nconst headerBurger = document.querySelector('.header-burger')\r\nconst headerBurgerMenu = document.querySelector('.header-burger-menu')\r\nconst headerBurgerClose = document.querySelector('.header-burger-close')\r\n\r\nconst headerBurgerMenuMedia = window.matchMedia('(max-width: 700px)')\r\n\r\nheaderBurger.addEventListener('click', () => {\r\n\theaderBurgerMenu.style.transition = 'width 0.2s linear, opacity 0.2s linear'\r\n\theaderBurgerMenu.style.display = 'flex'\r\n\tsetTimeout(() => {\r\n\t\tif (headerBurgerMenuMedia.matches) {\r\n\t\t\theaderBurgerMenu.style.width = '75vw'\r\n\t\t} else {\r\n\t\t\theaderBurgerMenu.style.width = '30vw'\r\n\t\t}\r\n\t\theaderBurgerMenu.style.opacity = '1'\r\n\t}, 10)\r\n\theaderBurgerClose.addEventListener('click', () => {\r\n\t\theaderBurgerMenu.style.width = '0vw'\r\n\t\theaderBurgerMenu.style.opacity = '0'\r\n\t\tsetTimeout(() => {\r\n\t\t\theaderBurgerMenu.style.display = 'none'\r\n\t\t}, 200)\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/burger.js?");

/***/ }),

/***/ "./src/js/modules/coffe-members-buttonChanger.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/coffe-members-buttonChanger.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n\r\nconst membersButtons = document.querySelectorAll('.members-navigation__button')\r\nconst membersButtonsArrows = document.querySelectorAll('.members-navigation__arrow')\r\n\r\nlet membersButtonsArrowsSrc\r\n\r\nmembersButtons.forEach((el, membersButtonsIndex) => {\r\n\tmembersButtons[membersButtonsIndex].style.transition = 'background-color 0.2s linear'\r\n\tmembersButtons[membersButtonsIndex].addEventListener('mouseover', () => {\r\n\t\tmembersButtons[membersButtonsIndex].style.backgroundColor = '#222222'\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrows[membersButtonsIndex].style.backgroundImage\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('url(\"', '')\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('\")', '')\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('-black.png', '')\r\n\t\tmembersButtonsArrows[membersButtonsIndex].style.backgroundImage = `url(\"${membersButtonsArrowsSrc}-white.png\")`\r\n\t\tconsole.log(membersButtonsArrowsSrc)\r\n\t\tif (membersButtonsIndex === 0) {\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.transform = 'rotate(180deg)'\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.top = '1.625rem'\r\n\t\t}\r\n\t\tif (membersButtonsIndex === 1) {\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.transform = 'rotate(0deg)'\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.top = '3.4rem'\r\n\t\t}\r\n\t})\r\n\tmembersButtons[membersButtonsIndex].addEventListener('mouseout', () => {\r\n\t\tmembersButtons[membersButtonsIndex].style.backgroundColor = 'rgba(34, 34, 34, 0.10)'\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrows[membersButtonsIndex].style.backgroundImage\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('url(\"', '')\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('\")', '')\r\n\t\tmembersButtonsArrowsSrc = membersButtonsArrowsSrc.replace('-white.png', '')\r\n\t\tmembersButtonsArrows[membersButtonsIndex].style.backgroundImage = `url(\"${membersButtonsArrowsSrc}-black.png\")`\r\n\t\tif (membersButtonsIndex === 0) {\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.transform = 'rotate(0deg)'\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.top = '3.25rem'\r\n\t\t}\r\n\t\tif (membersButtonsIndex === 1) {\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.transform = 'rotate(180deg)'\r\n\t\t\tmembersButtonsArrows[membersButtonsIndex].style.top = '1.75rem'\r\n\t\t}\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/coffe-members-buttonChanger.js?");
...
/***/ "./src/js/modules/our-dealer-buttonChanger.js":
/*!****************************************************!*\
  !*** ./src/js/modules/our-dealer-buttonChanger.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\nconst ourDealerButton = document.querySelector('.dealer-button')\r\nconst ourDealerArrow = document.querySelector('.dealer-button__path')\r\n\r\nconst ourDealerButtonHoverMedia = window.matchMedia('screen and (pointer: fine)')\r\n\r\nif (ourDealerButtonHoverMedia.matches) {\r\n\tourDealerButton.addEventListener('mouseover', () => {\r\n\t\tourDealerButton.style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\tourDealerArrow.style.transition = 'fill 0.2s'\r\n\t\tourDealerButton.style.backgroundColor = '#ffffff'\r\n\t\tourDealerButton.style.color = '#222222'\r\n\t\tourDealerArrow.style.fill = '#222222'\r\n\t})\r\n\r\n\tourDealerButton.addEventListener('mouseout', () => {\r\n\t\tourDealerButton.style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\tourDealerArrow.style.transition = 'fill 0.2s'\r\n\t\tourDealerButton.style.backgroundColor = '#222222'\r\n\t\tourDealerButton.style.color = '#ffffff'\r\n\t\tourDealerArrow.style.fill = '#ffffff'\r\n\t})\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/our-dealer-buttonChanger.js?");

/***/ }),

/***/ "./src/js/modules/quality-coffe-buttonChanger.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/quality-coffe-buttonChanger.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n\r\nconst qualityCoffeButton = document.querySelector('.quality-button')\r\nconst qualityCoffeArrow = document.querySelector('.quality-button__path')\r\n\r\nconst qualityButtonHoverMedia = window.matchMedia('screen and (pointer: fine)')\r\n\r\nif (qualityButtonHoverMedia.matches) {\r\n\tqualityCoffeButton.addEventListener('mouseover', () => {\r\n\t\tqualityCoffeButton.style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\tqualityCoffeArrow.style.transition = 'fill 0.2s'\r\n\t\tqualityCoffeButton.style.backgroundColor = '#ffffff'\r\n\t\tqualityCoffeButton.style.color = '#222222'\r\n\t\tqualityCoffeArrow.style.fill = '#222222'\r\n\t})\r\n\r\n\tqualityCoffeButton.addEventListener('mouseout', () => {\r\n\t\tqualityCoffeButton.style.transition = 'background-color 0.2s linear, color 0.2s linear'\r\n\t\tqualityCoffeArrow.style.transition = 'fill 0.2s'\r\n\t\tqualityCoffeButton.style.backgroundColor = '#222222'\r\n\t\tqualityCoffeButton.style.color = '#ffffff'\r\n\t\tqualityCoffeArrow.style.fill = '#ffffff'\r\n\t})\r\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/quality-coffe-buttonChanger.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ \"./node_modules/swiper/swiper-bundle.mjs\");\n\r\n\r\nconst swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiper', {\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\t// If we need pagination\r\n\tpagination: {\r\n\t\tel: '.swiper-pagination',\r\n\t},\r\n});\r\nconst swiperCart = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiper-cart', {\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\t// If we need pagination\r\n\tpagination: {\r\n\t\tel: '.swiper-pagination',\r\n\t},\r\n\tbreakpoints: {\r\n\t\t1200: {\r\n\t\t\tslidesPerView: 4\r\n\t\t},\r\n\t\t1000: {\r\n\t\t\tslidesPerView: 3\r\n\t\t},\r\n\t\t600: {\r\n\t\t\tslidesPerView: 2\r\n\t\t},\r\n\t\t0: {\r\n\t\t\tslidesPerView: 1\r\n\t\t}\r\n\t}\r\n});\r\nconst swiperMember = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiper-member', {\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\t// If we need pagination\r\n\tnavigation: {\r\n\t\tnextEl: '.swiper-button-next',\r\n\t\tprevEl: '.swiper-button-prev'\r\n\t},\r\n\tbreakpoints: {\r\n\t\t1200: {\r\n\t\t\tslidesPerView: 3,\r\n\t\t\tspaceBetween: 35\r\n\t\t},\r\n\t\t730: {\r\n\t\t\tslidesPerView: 2,\r\n\t\t\tspaceBetween: 25\r\n\t\t},\r\n\t\t0: {\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 0\r\n\t\t}\r\n\t}\r\n});\r\nconst swiperPosts = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiper-posts', {\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\tspaceBetween: 35,\r\n\tbreakpoints: {\r\n\t\t1500: {\r\n\t\t\tslidesPerView: 6,\r\n\t\t},\r\n\t\t1199: {\r\n\t\t\tslidesPerView: 5,\r\n\t\t},\r\n\t\t1000: {\r\n\t\t\tslidesPerView: 4,\r\n\t\t\tspaceBetween: 25\r\n\t\t},\r\n\t\t700: {\r\n\t\t\tslidesPerView: 3,\r\n\t\t\tspaceBetween: 25\r\n\t\t},\r\n\t\t400: {\r\n\t\t\tslidesPerView: 2,\r\n\t\t\tspaceBetween: 20\r\n\t\t},\r\n\t\t0: {\r\n\t\t\tslidesPerView: 1,\r\n\t\t\tspaceBetween: 0\r\n\t\t}\r\n\t}\r\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/swiper.js?");
